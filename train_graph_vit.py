...
model_config = config.config_graph_vit
...
model = models_graph_vit.GraphVisionTransformer(nside=dataset.nside,
                                                ...
                                                num_classes=4,
                                                superpix_mask_threshold=model_config['superpix_mask_threshold'])
